...
//			  u main funkciji, napraviti visa i master kartice i testirati funkcije
		...
		VisaKartica prva = new VisaKartica(156320, "741-963200012-23", 2024, 11, "Mira");
		MasterKartica druga = new MasterKartica(85090, "987-96300023-12", 2022, 12);

		
		prva.izvrsiTransakciju(500);
		prva.stampaj();
		druga.izvrsiTransakciju(1000);
		druga.stampaj();
	}
