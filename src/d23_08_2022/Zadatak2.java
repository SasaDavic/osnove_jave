...
//			Naravno u glavnom kreirati objekte i testirati funkcionalnosti 
		...
		Racun salje = new Racun("874-9868880000-36", "Mira Peric", 200000);
		
		Racun prima = new Racun("874-5698880000-36", "Pera Peric", 1000);
		
		Transakcija prva = new Transakcija(10001, salje, prima, 50000);
		prva.transakcijaPrima();
		prva.transakcijaSalje();
