...
//				Naravno u glavnom kreirati objekte i testirati funkcionalnosti 
		...
		Racun prvi = new Racun("203-963258000-96", "Mitar Miric", 960000);
		Racun drugi = new Racun("936-789654000-63", "Pera Peric", 5000);
		
		Transakcija transakcija = new Transakcija("MN6953", prvi, drugi);
		
		transakcija.izvrsiTransakciju(6500);
		transakcija.stamapaj();
